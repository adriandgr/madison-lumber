...
function PrivacyPolicy() {
  return (
    <div class="container container__privacy_policy">
        <div class="iub_content legal_pp">
          <div class="iub_header">
            <h1 className="title is-1">
              Privacy Policy of <strong>Madison's Lumber Directory</strong>
            </h1>
          ...
          <div class="one_line_col">
            <h2 className="title is-2">Owner and Data Controller</h2>
            <p>
              <strong>Madison's Lumber Reporter</strong> P.O. Box 2486.
              Vancouver, British Columbia V6B 3W7 Canada
            </p>
            <p>
              <b>Owner contact email:</b> contact@madisonsreport.com
            </p>
          </div>
          <div class="one_line_col">
            <h2 className="title is-2">Types of Data collected</h2>
            <p>
          ...
          <div class="content">
            ...
            <h3 className="title is-3">Methods of processing</h3>
            <p>
            ...
            <h3 className="title is-3">Legal basis of processing</h3>
            <p>
            ...
            <h3 className="title is-3">Place</h3>
            <p>
            ...
            <h3 className="title is-3">Retention time</h3>
            <p>
          ...
          <div class="one_line_col">
            <h2 className="title is-2">The purposes of processing</h2>
            <p>
              ...
              authentication provided directly by this Application.
            </p>
            ...
            <ul class="for_boxes">
              <li>
                <div class="box_primary box_10 expand">
                  <h3 className="title is-2 expand-click w_icon_24 policyicon_purpose_7313424">
                    Analytics
                  </h3>
                  <div class="expand-content">
                    ...
                    <h4>Matomo (this Application)</h4>
                    <div class="wrap">
                      <p>
                        Matomo is an analytics software used by this Application
                        to analyze data directly without the help of third
                        parties.
                      </p>
                    </div>
              ...
              <li>
                <div class="box_primary box_10 expand">
                  <h3 className="title is-3 expand-click w_icon_24 policyicon_purpose_7313737">
          ...
          <div class="content">
            <h2 className="title is-2">The rights of Users</h2>
            <p>
            ...
            <h3 className="title is-3">Details about the right to object to processing</h3>
            <p>
            ...
            <h3 className="title is-3">How to exercise these rights</h3>
            <p>
          ...
          <div class="one_line_col">
            ...
            <h3 className="title is-3">Legal action</h3>
            <p>
            ...
            <h3 className="title is-3">Additional information about User's Personal Data</h3>
            <p>
            ...
            <h3 className="title is-3">System logs and maintenance</h3>
            <p>
            ...
            <h3 className="title is-3">Information not contained in this policy</h3>
            <p>
            ...
            <h3 className="title is-3">How “Do Not Track” requests are handled</h3>
            <p>
          ...
          <div class="one_line_col">
            <div class="box_primary box_10 definitions expand">
              <h3
                ...
                className="title is-3 expand-click w_icon_24 icon_ribbon"
              >
                Definitions and legal references
              </h3>
              <div class="expand-content">
                <h4 className="title is-4">Personal Data (or Data)</h4>
                <p>
                ...
                <h4 className="title is-4">Usage Data</h4>
                <p>
                ...
                <h4 className="title is-4">Data Subject</h4>
                <p>The natural person to whom the Personal Data refers.</p>

                <h4 className="title is-4">Data Processor (or Data Supervisor)</h4>
                <p>
                ...
                <h4 className="title is-4">Data Controller (or Owner)</h4>
                <p>
                  The natural or legal person, public authority, agency or other
                ...
                <hr />
                <h4 className="title is-4">Legal information</h4>
                <p>
          ...
          <div class="iub_footer">
            <p>Latest update: July 03, 2020</p>

          
            <a
              href="//www.iubenda.com/privacy-policy/78499701"
      ...
      <div class="iub_footer">
        <p>
          ...
          <a
            href="https://www.iubenda.com/privacy-policy/78499701/legal"
            class="no_border"
            title="iubenda"
            target="_blank"
            rel="noopener"
          >
            <img
              alt="iubenda"
              src="//www.iubenda.com/assets/site/logo_min.png"
            />
          </a>
        </p>

        <a
          href="//www.iubenda.com"
          target="_blank"
          rel="noopener"
          class="btn iubgreen"
